...
` +
    ...
    function xi(e, t, n, r, i, a) {
      ...
      if (((r = e), typeof e == `function`)) vi(e) && (o = 1);
        ...
        o = Uf(e, n, me.current) ? 26 : e === `html` || e === `head` || e === `body` ? 27 : 5;
      else
        a: switch (e) {
          case ie:
    ...
    function Di(e, t) {
      if (typeof e == `object` && e) {
        var n = Ei.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: Oe(t) }), Ei.set(e, t), t) : n;
      }
    ...
    function Wa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return a === y
          ...
          : t !== null &&
              (t.elementType === a ||
                (typeof a == `object` && a && a.$$typeof === w && Fa(a) === t.type))
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case _:
              return (
                (n = xi(t.type, t.key, t.props, null, e.mode, n)), Ha(n, t), (n.return = e), n
              );
            case v:
          ...
          switch (a.$$typeof) {
            case _:
              a: {
                ...
                a.type === y
                  ? ((c = Si(a.props.children, e.mode, c, a.key)), (c.return = e), (e = c))
    ...
    function oc(e, t, n, r, i) {
      ...
      if (((a = Di(a, n)), Zl === null ? (Zl = [a]) : Zl.push(a), Y !== 4 && (Y = 2), t === null))
        return !0;
      ((r = Di(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function _c(e, t, n) {
      ...
      if (a !== null) {
        ...
        if ((mo(t), i))
          ...
          if (((r = G), r !== null && ((o = lt(r, n)), o !== 0 && o !== a.retryLane)))
    ...
    function Ec(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (a)
          ...
          if (((o = G), o !== null && ((r = lt(o, n)), r !== 0 && r !== l.retryLane)))
    ...
    function Hc(e, t, n) {
      ...
      switch ((Bi(t), t.tag)) {
        ...
        case 27:
          if ((xe(t), (n = ge.current), (i = t.type), e !== null && t.stateNode != null))
...
`,
  ...
  te = _(`loader-circle`, [[`path`, { d: `M21 12a9 9 0 1 1-6.219-8.56`, key: `13zald` }]]),
  ne = _(`message-square`, [
    [
      `path`,
      {
...
function de() {
  let e = (0, h.useRef)(null),
    ...
    [n, r] = (0, h.useState)(!1),
    [i, a] = (0, h.useState)(!1),
    [o, s] = (0, h.useState)(null),
    [c, l] = (0, h.useState)([]),
    [u, d] = (0, h.useState)([]),
    [f, p] = (0, h.useState)([]),
    [m, g] = (0, h.useState)(null),
    _ = (0, h.useCallback)((t) => {
      e.current?.readyState === WebSocket.OPEN && e.current.send(JSON.stringify(t));
    }, []),
    v = (0, h.useCallback)((e) => {
      try {
        ...
        switch (t.type) {
          case `connection-status`:
            (a(t.t3Connected), s(t.t3Url));
            break;
          case `snapshot`:
            (l(t.pairs), d(t.projects), p(t.threads));
            break;
          case `pair-created`:
            l((e) => [...e, t.pair]);
            break;
          case `pair-updated`:
            l((e) => e.map((e) => (e.id === t.pair.id ? t.pair : e)));
            break;
          case `pair-removed`:
            l((e) => e.filter((e) => e.id !== t.pairId));
            break;
          case `new-message`:
            l((e) =>
              e.map((e) =>
                e.id === t.pairId ? { ...e, messages: [...e.messages, t.message] } : e,
              ),
            );
            break;
    ...
    y = (0, h.useCallback)(() => {
      let n = `${window.location.protocol === `https:` ? `wss:` : `ws:`}//${window.location.host}/relay-ws`,
        i = new WebSocket(n);
      ((e.current = i),
        (i.onopen = () => {
          (r(!0), g(null));
        ...
        (i.onmessage = v),
        (i.onclose = () => {
          (r(!1), (e.current = null), (t.current = setTimeout(y, 2e3)));
        }),
        (i.onerror = () => {
          i.close();
        }));
  ...
  return (
    (0, h.useEffect)(
      () => (
        y(),
        () => {
          (clearTimeout(t.current), e.current?.close());
        }
      ),
      [y],
    ),
    {
      ...
      threads: f,
      error: m,
      connectToT3: (0, h.useCallback)(
        (e, t) => _({ type: `connect-t3`, url: e, credential: t }),
        [_],
      ),
      disconnectFromT3: (0, h.useCallback)(() => _({ type: `disconnect-t3` }), [_]),
      createPair: (0, h.useCallback)((e) => _({ type: `create-pair`, config: e }), [_]),
      startPair: (0, h.useCallback)((e) => _({ type: `start-pair`, pairId: e }), [_]),
      stopPair: (0, h.useCallback)((e) => _({ type: `stop-pair`, pairId: e }), [_]),
      deletePair: (0, h.useCallback)((e) => _({ type: `delete-pair`, pairId: e }), [_]),
      clearError: (0, h.useCallback)(() => g(null), []),
    }
  );
}
var fe = e((e) => {
  ...
  pe = { idle: S, running: te, paused: S, completed: x, stopped: ee, error: b },
  O = {
    idle: `text-zinc-500`,
...
function k({
  ...
  let s = new Set(e.flatMap((e) => [e.threadA.id, e.threadB.id]));
  return (
    t.filter((e) => !s.has(e.id)),
    (0, D.jsxs)(`div`, {
      className: `flex h-full w-72 flex-col border-r border-zinc-800 bg-zinc-950`,
      children: [
        (0, D.jsxs)(`div`, {
          ...
          children: [
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsx)(v, { className: `size-4 text-zinc-400` }),
                (0, D.jsx)(`span`, {
                  className: `text-sm font-semibold text-zinc-200`,
                  children: `Chat Pairs`,
                }),
                (0, D.jsx)(`span`, {
                  className: `rounded-full bg-zinc-800 px-1.5 py-0.5 text-xs text-zinc-500`,
                  children: e.length,
                }),
              ],
            }),
            (0, D.jsx)(`button`, {
              ...
              children: (0, D.jsx)(w, { className: `size-4` }),
            }),
          ],
        }),
        (0, D.jsxs)(`div`, {
          ...
          children: [
              ...
              children:
                e.length === 0
                  ? (0, D.jsxs)(`div`, {
                      ...
                      children: [
                        (0, D.jsx)(v, { className: `size-8 text-zinc-800` }),
                        (0, D.jsxs)(`p`, {
                  ...
                  : (0, D.jsx)(`div`, {
                      ...
                      children: e.map((e) => {
                        ...
                        return (0, D.jsxs)(
                          ...
                          {
                            onClick: () => i(e.id),
                            className: `w-full rounded-lg px-3 py-2.5 text-left transition ${e.id === n ? `bg-zinc-800 ring-1 ring-zinc-700` : `hover:bg-zinc-900`}`,
                            children: [
                              (0, D.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, D.jsx)(t, {
                                    className: `size-3.5 flex-shrink-0 ${O[e.status]} ${e.status === `running` ? `animate-spin` : ``}`,
                                  }),
                                ],
                              }),
                              (0, D.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, D.jsxs)(`span`, {
                                    className: `truncate`,
                                    children: [e.threadA.label, ` / `, e.threadB.label],
                                  }),
                                  (0, D.jsxs)(`span`, {
                                    className: `flex-shrink-0 text-zinc-700`,
                                    children: [`T`, e.turnCount],
                                  }),
                                ],
                              }),
                              e.messages.length > 0 &&
                                (0, D.jsx)(`p`, {
                                  ...
                                  children: e.messages[e.messages.length - 1].originalText.slice(
                                    0,
                                    60,
                                  ),
                                }),
            ...
            t.length > 0 &&
              (0, D.jsxs)(D.Fragment, {
                children: [
                  (0, D.jsxs)(`div`, {
                    className: `flex items-center gap-2 border-t border-zinc-800 px-4 py-2.5`,
                    children: [
                      (0, D.jsx)(ne, { className: `size-3.5 text-zinc-500` }),
                      (0, D.jsx)(`span`, {
                        className: `text-xs font-semibold text-zinc-400`,
                        children: `All T3 Threads`,
                      }),
                      (0, D.jsx)(`span`, {
                        className: `rounded-full bg-zinc-800 px-1.5 py-0.5 text-xs text-zinc-600`,
                        children: t.length,
                      }),
                    ],
                  }),
                  (0, D.jsx)(`div`, {
                    ...
                    children: t.map((e) => {
                      ...
                      return (0, D.jsxs)(
                        ...
                        {
                          onClick: () => a(e.id),
                          className: `w-full rounded-lg px-3 py-2 text-left transition ${t ? `bg-zinc-800 ring-1 ring-zinc-700` : `hover:bg-zinc-900`}`,
                          children: [
                            (0, D.jsxs)(`div`, {
                              className: `flex items-center gap-1.5`,
                              children: [
                                (0, D.jsx)(C, { className: `size-3 flex-shrink-0 text-zinc-600` }),
                                (0, D.jsx)(`span`, {
                            ...
                            (0, D.jsxs)(`div`, {
                              className: `mt-0.5 flex items-center gap-2 pl-4.5 text-xs text-zinc-600`,
                              children: [
                                (0, D.jsxs)(`span`, { children: [e.messageCount, ` msgs`] }),
                                n &&
                                  e.pairSide &&
                                  (0, D.jsxs)(`span`, {
                                    className: `rounded bg-zinc-800 px-1 text-zinc-500`,
                                    children: [`relay `, e.pairSide],
                                  }),
                                e.turnState === `running` &&
                                  (0, D.jsx)(`span`, {
                            ...
                            e.lastMessagePreview &&
                              (0, D.jsx)(`p`, {
                                className: `mt-0.5 truncate pl-4.5 text-xs text-zinc-700`,
...
function me({ message: e, threadA: t, threadB: n }) {
  let r = e.source === `system`,
    i = e.source === `A`,
    a = e.source === `B`,
    o = i ? t.label : a ? n.label : `System`,
    s = e.role === `assistant`,
    c = e.role === `user` && e.relayedText;
  return r
    ? (0, D.jsx)(`div`, {
        className: `animate-slide-in flex justify-center py-2`,
        children: (0, D.jsxs)(`div`, {
          className: `inline-flex items-center gap-2 rounded-full bg-zinc-800/60 px-4 py-1.5 text-xs text-zinc-400`,
          children: [
            (0, D.jsx)(`span`, { className: `size-1.5 rounded-full bg-relay-system` }),
            e.originalText,
          ],
        }),
      })
    : c
      ? (0, D.jsx)(`div`, {
          className: `animate-slide-in flex justify-center py-1`,
          children: (0, D.jsxs)(`div`, {
            className: `inline-flex items-center gap-2 rounded-full bg-zinc-800/40 px-3 py-1 text-xs text-zinc-500`,
            children: [
              (0, D.jsx)(`span`, {
                children: i ? `${t.label} \u2192 ${n.label}` : `${n.label} \u2192 ${t.label}`,
              }),
              e.relayedText !== e.originalText &&
                (0, D.jsx)(`span`, { className: `text-amber-500/70`, children: `(modified)` }),
            ],
          }),
        })
      : (0, D.jsxs)(`div`, {
          className: `animate-slide-in flex flex-col gap-1 py-2 ${i ? `items-start` : `items-end`}`,
          children: [
            (0, D.jsxs)(`div`, {
              className: `flex items-center gap-2 px-1`,
              children: [
                (0, D.jsx)(`span`, {
                  className: `size-2 rounded-full ${i ? `bg-relay-a` : `bg-relay-b`}`,
                }),
                (0, D.jsx)(`span`, { className: `text-xs font-medium text-zinc-400`, children: o }),
                (0, D.jsx)(`span`, {
                  className: `text-xs text-zinc-600`,
                  children: s ? `responded` : `sent`,
                }),
                (0, D.jsxs)(`span`, {
                  className: `text-xs text-zinc-700`,
                  children: [`T`, e.turnNumber],
                }),
              ],
            }),
            (0, D.jsx)(`div`, {
              className: `max-w-[85%] rounded-xl px-4 py-3 text-sm leading-relaxed ${i ? `bg-relay-a/10 text-zinc-200 rounded-tl-sm` : `bg-relay-b/10 text-zinc-200 rounded-tr-sm`}`,
...
var he = {
  idle: { icon: S, label: `Idle`, color: `text-zinc-500`, bg: `bg-zinc-800` },
  running: { icon: te, label: `Running`, color: `text-emerald-400`, bg: `bg-emerald-950/50` },
  paused: { icon: S, label: `Paused`, color: `text-amber-400`, bg: `bg-amber-950/50` },
  completed: { icon: x, label: `Completed`, color: `text-blue-400`, bg: `bg-blue-950/50` },
  stopped: { icon: ee, label: `Stopped`, color: `text-zinc-400`, bg: `bg-zinc-800` },
  error: { icon: b, label: `Error`, color: `text-red-400`, bg: `bg-red-950/50` },
};
function ge({ pair: e, onStart: t, onStop: n, onDelete: r }) {
  ...
  let a = he[e.status],
    o = a.icon,
    s = e.status === `running`,
    c = e.status === `idle` || e.status === `stopped` || e.status === `error`,
    l = e.status === `running`;
  return (0, D.jsxs)(`div`, {
    ...
    children: [
      (0, D.jsxs)(`div`, {
        ...
        children: [
          (0, D.jsx)(`div`, {
            ...
            children: (0, D.jsxs)(`div`, {
              children: [
                ...
                (0, D.jsxs)(`div`, {
                  className: `mt-0.5 flex items-center gap-3 text-xs text-zinc-500`,
                  children: [
                    (0, D.jsxs)(`span`, {
                      className: `flex items-center gap-1`,
                      children: [
                        (0, D.jsx)(`span`, { className: `size-2 rounded-full bg-relay-a` }),
                        e.threadA.label,
                      ],
                    }),
                    (0, D.jsx)(v, { className: `size-3` }),
                    (0, D.jsxs)(`span`, {
                      className: `flex items-center gap-1`,
                      children: [
                        (0, D.jsx)(`span`, { className: `size-2 rounded-full bg-relay-b` }),
                        e.threadB.label,
                      ],
                    }),
                    (0, D.jsx)(`span`, { className: `text-zinc-600`, children: `|` }),
                    (0, D.jsxs)(`span`, {
                      children: [
                        `Turn `,
                        e.turnCount,
                        e.config.maxTurns > 0 ? ` / ${e.config.maxTurns}` : ``,
                      ],
                    }),
                  ],
                }),
          ...
          (0, D.jsxs)(`div`, {
            ...
            children: [
              (0, D.jsxs)(`div`, {
                className: `flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium ${a.bg} ${a.color}`,
                children: [
                  (0, D.jsx)(o, { className: `size-3.5 ${s ? `animate-spin` : ``}` }),
                  a.label,
                  e.waitingFor &&
                    s &&
                    (0, D.jsxs)(`span`, {
                      ...
                      children: [
                        `(waiting for `,
                        e.waitingFor === `A` ? e.threadA.label : e.threadB.label,
                        `)`,
                      ],
                    }),
                ],
              ...
              c &&
                (0, D.jsxs)(`button`, {
                  ...
                  children: [
                    (0, D.jsx)(re, { className: `size-3.5` }),
                    e.messages.length > 0 ? `Resume` : `Start`,
                  ],
                }),
              l &&
                (0, D.jsxs)(`button`, {
      ...
      e.error &&
        (0, D.jsx)(`div`, {
          className: `border-b border-red-900/50 bg-red-950/30 px-6 py-2 text-xs text-red-400`,
          children: e.error,
        }),
      (0, D.jsx)(`div`, {
          ...
          e.messages.length === 0
            ? (0, D.jsx)(`div`, {
                ...
                children: (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    (0, D.jsx)(v, { className: `mx-auto size-12 text-zinc-800` }),
                    (0, D.jsx)(`p`, {
                      className: `mt-3 text-sm text-zinc-600`,
                      children: `No messages yet. Start the relay to begin.`,
                    }),
                  ],
                }),
              })
            : (0, D.jsxs)(`div`, {
                ...
                children: [
                  e.messages.map((t) =>
                    (0, D.jsx)(me, { message: t, threadA: e.threadA, threadB: e.threadB }, t.id),
                  ),
                  s &&
                    (0, D.jsxs)(`div`, {
                      className: `flex items-center gap-2 py-3 text-xs text-zinc-500`,
                      children: [
                        (0, D.jsxs)(`span`, {
      ...
      (0, D.jsx)(`div`, {
        className: `border-t border-zinc-800/60 px-6 py-3`,
        children: (0, D.jsxs)(`div`, {
          className: `flex flex-wrap gap-x-6 gap-y-1 text-xs text-zinc-600`,
          children: [
            (0, D.jsxs)(`span`, {
              children: [
                `Model: `,
                (0, D.jsx)(`span`, {
                  ...
                  children: e.config.modelSelection.model,
                }),
              ],
            }),
            (0, D.jsxs)(`span`, {
              children: [
                `Mode: `,
                (0, D.jsx)(`span`, { className: `text-zinc-400`, children: e.config.runtimeMode }),
              ],
            }),
            e.config.stopSignal &&
              (0, D.jsxs)(`span`, {
                children: [
                  `Stop: `,
                  (0, D.jsx)(`code`, {
                    className: `rounded bg-zinc-800 px-1 text-zinc-400`,
                    children: e.config.stopSignal,
                  }),
                ],
              }),
            e.config.modificationsAtoB.length > 0 &&
              (0, D.jsxs)(`span`, {
                children: [
                  `A`,
                  `→`,
                  ...
                  (0, D.jsx)(`span`, {
                    ...
                    children: e.config.modificationsAtoB.length,
                  }),
                ],
              }),
            e.config.modificationsBtoA.length > 0 &&
              (0, D.jsxs)(`span`, {
                children: [
                  `B`,
                  `→`,
                  ...
                  (0, D.jsx)(`span`, {
                    className: `text-amber-500/70`,
                    children: e.config.modificationsBtoA.length,
                  }),
                ],
              }),
          ],
...
function _e({ thread: e }) {
  return (0, D.jsxs)(`div`, {
    className: `flex h-full flex-col`,
    children: [
      (0, D.jsxs)(`div`, {
        className: `flex items-center gap-3 border-b border-zinc-800 px-6 py-4`,
        children: [
          (0, D.jsx)(C, { className: `size-5 text-zinc-500` }),
          (0, D.jsxs)(`div`, {
            children: [
              (0, D.jsx)(`h2`, {
                className: `text-lg font-semibold text-zinc-100`,
              ...
              (0, D.jsxs)(`div`, {
                className: `mt-0.5 flex items-center gap-3 text-xs text-zinc-500`,
                children: [
                  (0, D.jsxs)(`span`, { children: [e.messageCount, ` messages`] }),
                  e.pairId &&
                    (0, D.jsxs)(`span`, {
                      className: `rounded bg-zinc-800 px-1.5 py-0.5 text-zinc-400`,
                      children: [`Relay pair `, e.pairSide],
                    }),
                  e.turnState &&
                    (0, D.jsx)(`span`, {
                      className:
                        e.turnState === `running`
                          ...
                          : e.turnState === `error`
                            ? `text-red-400`
                            : `text-zinc-400`,
                      children: e.turnState,
                    }),
                  (0, D.jsx)(`span`, { className: `font-mono text-zinc-700`, children: e.id }),
                ],
              }),
            ],
          }),
          ...
          e.messageCount === 0
            ? (0, D.jsx)(`div`, {
                ...
                children: (0, D.jsxs)(`div`, {
                  className: `text-center`,
                  children: [
                    (0, D.jsx)(ne, { className: `mx-auto size-12 text-zinc-800` }),
                    (0, D.jsx)(`p`, {
                      className: `mt-3 text-sm text-zinc-600`,
                      children: `This thread has no messages yet.`,
                    }),
                  ],
                }),
              })
            : (0, D.jsxs)(`div`, {
                ...
                children: [
                  (0, D.jsx)(ne, { className: `mx-auto mb-3 size-10 text-zinc-700` }),
                  (0, D.jsxs)(`p`, {
                    children: [
                      `This thread has `,
                      (0, D.jsx)(`strong`, {
                  ...
                  e.lastMessagePreview &&
                    (0, D.jsxs)(`p`, {
                      className: `mx-auto mt-3 max-w-lg rounded-lg bg-zinc-900 p-3 text-left text-xs text-zinc-400`,
                      children: [e.lastMessagePreview, `...`],
                    }),
                  e.pairId &&
                    (0, D.jsx)(`p`, {
                      className: `mt-4 text-xs text-zinc-600`,
                      children: `Select the relay pair in the sidebar to see the full conversation.`,
                    }),
                ],
              }),
      }),
            ...
            e.lastActivityAt &&
              (0, D.jsxs)(`span`, {
                children: [
                  ...
                  (0, D.jsx)(`span`, {
                    className: `text-zinc-400`,
                    children: new Date(e.lastActivityAt).toLocaleString(),
                  }),
                ],
              }),
          ],
...
function ve({ label: e, modifications: t, onChange: n }) {
  let r = () => {
      n([...t, { type: `prefix`, value: `` }]);
    },
    i = (e) => {
      n(t.filter((t, n) => n !== e));
    },
    a = (e, r) => {
      n(t.map((t, n) => (n === e ? { ...t, ...r } : t)));
    };
  return (0, D.jsxs)(`div`, {
    children: [
      (0, D.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, D.jsxs)(`button`, {
            ...
            children: [(0, D.jsx)(w, { className: `size-3` }), `Add`],
          }),
        ],
      }),
      t.length === 0
        ? (0, D.jsx)(`p`, {
            ...
            children: `No modifications. Output will be relayed as-is.`,
          })
        : (0, D.jsx)(`div`, {
            className: `space-y-2`,
            children: t.map((e, t) =>
              (0, D.jsxs)(
                `div`,
                {
                  ...
                  children: [
                    (0, D.jsxs)(`select`, {
                      value: e.type,
                      onChange: (e) => a(t, { type: e.target.value }),
                      className: `rounded bg-zinc-700 px-2 py-1 text-xs text-zinc-200`,
                      children: [
                        (0, D.jsx)(`option`, { value: `prefix`, children: `Prefix` }),
                        (0, D.jsx)(`option`, { value: `suffix`, children: `Suffix` }),
                        (0, D.jsx)(`option`, { value: `replace`, children: `Replace` }),
                        (0, D.jsx)(`option`, { value: `wrap`, children: `Wrap` }),
                      ],
                    }),
                    (0, D.jsxs)(`div`, {
                    ...
                    (0, D.jsx)(`button`, {
                      ...
                      children: (0, D.jsx)(T, { className: `size-3` }),
                    }),
                  ],
                },
                t,
...
var ye = {
  ...
  be = { claudeAgent: `claude-sonnet-4-6`, codex: `gpt-5.4` };
function xe({ projects: e, onClose: t, onCreate: n }) {
  let [r, i] = (0, h.useState)(``),
    [a, o] = (0, h.useState)(e[0]?.id ?? ``),
    [s, c] = (0, h.useState)(`claudeAgent`),
    [l, u] = (0, h.useState)(be.claudeAgent),
    [d, f] = (0, h.useState)(`full-access`),
    [p, m] = (0, h.useState)(`Agent A`),
    [g, _] = (0, h.useState)(`Agent B`),
    [v, b] = (0, h.useState)(``),
    [x, ee] = (0, h.useState)(`\\[STOP\\]`),
    [S, C] = (0, h.useState)(10),
    [te, ne] = (0, h.useState)([]),
    [re, w] = (0, h.useState)([]),
    ie = r.trim() && a && v.trim();
  return (0, D.jsx)(`div`, {
    ...
    children: (0, D.jsxs)(`div`, {
      className: `max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl`,
      children: [
        (0, D.jsxs)(`div`, {
          className: `flex items-center justify-between border-b border-zinc-800 px-6 py-4`,
          children: [
            (0, D.jsxs)(`div`, {
              className: `flex items-center gap-2`,
              children: [
                (0, D.jsx)(ce, { className: `size-5 text-zinc-400` }),
                (0, D.jsx)(`h2`, {
                  className: `text-lg font-semibold text-zinc-100`,
                  children: `Create Chat Pair`,
                }),
              ],
            }),
            (0, D.jsx)(`button`, {
              ...
              children: (0, D.jsx)(T, { className: `size-5` }),
            }),
          ],
        }),
        (0, D.jsxs)(`form`, {
            ...
            (e.preventDefault(),
              ie &&
                (n({
                  name: r.trim(),
                  projectId: a,
                  modelSelection: { provider: s, model: l },
                  runtimeMode: d,
                  labelA: p,
                  labelB: g,
                  ...
                  stopSignal: x,
                  maxTurns: S,
                  modificationsAtoB: te,
                  modificationsBtoA: re,
                }),
                t()));
          },
          ...
          children: [
                ...
                (0, D.jsxs)(`div`, {
                  children: [
                    ...
                    (0, D.jsx)(`select`, {
                      ...
                      children: e.map((e) =>
                        (0, D.jsx)(`option`, { value: e.id, children: e.title }, e.id),
                      ),
                    }),
                  ],
                }),
                (0, D.jsxs)(`div`, {
                  children: [
                    ...
                    (0, D.jsxs)(`select`, {
                      ...
                      className: `w-full rounded-lg bg-zinc-800 px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-600`,
                      children: [
                        (0, D.jsx)(`option`, { value: `full-access`, children: `Full Access` }),
                        (0, D.jsx)(`option`, {
                          value: `auto-accept-edits`,
                          children: `Auto-Accept Edits`,
                        }),
                        (0, D.jsx)(`option`, {
                ...
                (0, D.jsxs)(`div`, {
                  children: [
                    ...
                    (0, D.jsxs)(`select`, {
                      ...
                      className: `w-full rounded-lg bg-zinc-800 px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-600`,
                      children: [
                        (0, D.jsx)(`option`, { value: `claudeAgent`, children: `Claude Agent` }),
                        (0, D.jsx)(`option`, { value: `codex`, children: `Codex` }),
                      ],
                    }),
                  ],
                }),
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsxs)(`div`, {
                  children: [
                    (0, D.jsxs)(`label`, {
                      className: `mb-1 flex items-center gap-2 text-xs font-medium text-zinc-400`,
                      children: [
                        (0, D.jsx)(`span`, { className: `size-2 rounded-full bg-relay-a` }),
                        `Thread A Label`,
                      ],
            ...
            (0, D.jsxs)(`div`, {
              children: [
                (0, D.jsx)(`label`, {
                  className: `mb-1 block text-xs font-medium text-zinc-400`,
                  children: `Initial Message (sent to Thread A to start)`,
                }),
                (0, D.jsx)(`textarea`, {
                  value: v,
                ...
                (0, D.jsxs)(`div`, {
                  children: [
                    ...
                    (0, D.jsx)(`p`, {
                      ...
                      children: `If either agent's response matches this regex, the relay stops.`,
                    }),
                  ],
                }),
                (0, D.jsxs)(`div`, {
                  children: [
                    (0, D.jsx)(`label`, {
                      className: `mb-1 block text-xs font-medium text-zinc-400`,
                      children: `Max Turns (0 = unlimited)`,
                    }),
                    (0, D.jsx)(`input`, {
                      type: `number`,
                      value: S,
                      onChange: (e) => C(Math.max(0, parseInt(e.target.value) || 0)),
                      min: 0,
                      className: `w-full rounded-lg bg-zinc-800 px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-600`,
                    }),
                  ],
            ...
            (0, D.jsxs)(`div`, {
              className: `space-y-4 rounded-xl bg-zinc-800/30 p-4`,
              children: [
                (0, D.jsxs)(`div`, {
                  className: `flex items-center gap-2 text-sm font-medium text-zinc-300`,
                  children: [(0, D.jsx)(ce, { className: `size-4` }), `Message Modifications`],
                }),
                (0, D.jsx)(ve, {
                  label: (0, D.jsxs)(`span`, {
                    className: `flex items-center gap-1`,
...
function Se({ onConnect: e, connecting: t }) {
  let [n, r] = (0, h.useState)(`http://localhost:3773`),
    [i, a] = (0, h.useState)(``);
  return (0, D.jsx)(`div`, {
    className: `flex h-full items-center justify-center`,
    children: (0, D.jsxs)(`div`, {
      ...
      children: [
        (0, D.jsxs)(`div`, {
          ...
          children: [
            (0, D.jsx)(ae, { className: `mx-auto size-10 text-zinc-600` }),
            (0, D.jsx)(`h1`, {
              className: `mt-3 text-xl font-bold text-zinc-100`,
              children: `Chat Relay`,
            }),
            (0, D.jsx)(`p`, {
              className: `mt-1 text-sm text-zinc-500`,
              children: `Connect to a running T3 Code server to create chat pairs.`,
            }),
          ],
        }),
        (0, D.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, D.jsxs)(`p`, {
                  ...
                  children: [
                    ...
                    ` `,
                    (0, D.jsx)(`code`, {
                      className: `rounded bg-zinc-800 px-1`,
                      children: `t3 auth pairing create`,
                    }),
                  ],
                }),
              ],
...
function Ce() {
  let e = de(),
    [t, n] = (0, h.useState)(null),
    [r, i] = (0, h.useState)(!1),
    [a, o] = (0, h.useState)(!1),
    s = t?.kind === `pair` ? e.pairs.find((e) => e.id === t.id) : void 0,
    c = t?.kind === `thread` ? e.threads.find((e) => e.id === t.id) : void 0;
  return e.connected
    ? e.t3Connected
      ? (0, D.jsxs)(`div`, {
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsxs)(`div`, {
                  className: `flex items-center gap-3`,
                  children: [
                    (0, D.jsx)(v, { className: `size-4 text-zinc-500` }),
                    (0, D.jsx)(`span`, {
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, D.jsxs)(`div`, {
                      ...
                      children: [
                        (0, D.jsx)(ue, { className: `size-3.5 text-emerald-500` }),
                        (0, D.jsx)(`span`, { className: `text-emerald-500/70`, children: e.t3Url }),
                      ],
                    }),
                    (0, D.jsxs)(`button`, {
                      onClick: e.disconnectFromT3,
                      ...
                      children: [(0, D.jsx)(se, { className: `size-3.5` }), `Disconnect`],
                    }),
                  ],
                }),
              ],
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsx)(k, {
                  pairs: e.pairs,
                  threads: e.threads,
                  selectedPairId: t?.kind === `pair` ? t.id : null,
                  selectedThreadId: t?.kind === `thread` ? t.id : null,
                  onSelectPair: (e) => n({ kind: `pair`, id: e }),
                  onSelectThread: (e) => n({ kind: `thread`, id: e }),
                  onCreateNew: () => i(!0),
                }),
                (0, D.jsx)(`div`, {
                  className: `flex-1`,
                    ...
                    : c
                      ...
                      : (0, D.jsx)(`div`, {
                          ...
                          children: (0, D.jsxs)(`div`, {
                            className: `text-center`,
                            children: [
                              (0, D.jsx)(ie, { className: `mx-auto size-12 text-zinc-800` }),
                              (0, D.jsx)(`p`, {
                                className: `mt-3 text-sm text-zinc-600`,
                                children: `Select a pair or thread from the sidebar, or create a new pair.`,
                              }),
                              (0, D.jsx)(`button`, {
                                onClick: () => i(!0),
      ...
      : (0, D.jsxs)(`div`, {
          ...
          children: [
            e.error &&
              (0, D.jsxs)(`div`, {
                className: `border-b border-red-900/50 bg-red-950/30 px-6 py-2 text-center text-sm text-red-400`,
                children: [
                  e.error,
                  (0, D.jsx)(`button`, {
                    onClick: e.clearError,
            ...
            (0, D.jsx)(Se, {
              onConnect: (t, n) => {
                (o(!0), e.connectToT3(t, n), setTimeout(() => o(!1), 3e3));
              },
              connecting: a,
            }),
          ],
    ...
    : (0, D.jsx)(`div`, {
        className: `flex h-screen items-center justify-center bg-zinc-950 text-zinc-100`,
        children: (0, D.jsxs)(`div`, {
          className: `text-center`,
          children: [
            (0, D.jsx)(le, { className: `mx-auto size-10 text-zinc-700` }),
            (0, D.jsx)(`p`, {
              className: `mt-3 text-sm text-zinc-500`,
              children: `Connecting to relay server...`,
            }),
          ],
        }),
      });
...
(0, E.createRoot)(document.getElementById(`root`)).render(
  (0, D.jsx)(h.StrictMode, { children: (0, D.jsx)(Ce, {}) }),
);
